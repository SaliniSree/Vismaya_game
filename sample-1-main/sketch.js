...
function preload(){
  ...
  aster1IMG=loadImage("as1.png");
  aster2IMG=loadImage("as2.png");
  aster3IMG=loadImage("as3.png");
  aster4IMG=loadImage("as4.png");
  aster5IMG=loadImage("as5.png")
  star1IMG=loadImage("star1.png");
  saturnIMG=loadImage("saturn2.png");
  man_rightIMG=loadImage("running_right.png") //////////////////changed to right as rocket on left side
  astromanIMG=loadImage("astroman.jpg")
  ongroundbgIMG=loadImage("enviro.png")
  bg2IMG=loadImage("bg2.png")
 surIMG=loadImage("sur_with_astronaut.png")
}
...
if(gameState =='landed'){           ////////////////////////////added
  ...
  back.destroy()
  rocket.destroy()
back1 = createSprite(600,400)
back1.addImage(surIMG)

  man_right=createSprite(600,600)
  man_right.addImage(man_rightIMG)
